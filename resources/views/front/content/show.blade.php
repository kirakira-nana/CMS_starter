            ...
            <div class="flex w-full md:w-1/2">
                <div class="px-8">
                    ...
                    <ul class="list-reset items-center text-sm pt-3">
                        <li>
                            <a class="inline-block text-grey-dark no-underline hover:text-black hover:text-underline py-1" href="https://github.com/kirakira-nana" target="_blank">GitHub</a>
                        </li>
                    </ul>
                </div>
            </div>
